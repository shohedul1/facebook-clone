        ...
        <header className='bg-white dark:bg-black text-foreground shadow-md fixed h-16 left-0 right-0 top-0 z-50 p-2'>
            <div className='mx-auto flex items-center justify-between p-2'>
                <div className='flex items-center gap-7 md:gap-4'>
                    <Image src={'/images/facebook.webp'} width={40} height={40} alt='image' />
                ...
                <nav className='hidden md:flex justify-around w-[40%] max-w-md '>
                    {
                        [
                            ...
                            return (
                                <Button key={name} variant="ghost" size="icon" className="relative text-gray-600 dark:text-gray-400 hover:text-blue-600 hover:bg-transparent">
                                    <Icon />
                                </Button>
                            )
                        })
                ...
                <div className='flex space-x-2 md:space-x-4 items-center'>
                    <Button onClick={toggleSidebar}
                        variant="ghost" size="icon" className="md:hidden text-gray-600 cursor-pointer">
                        <Menu />
                    </Button>
                    <Button variant="ghost" size="icon" className="hidden md:block text-gray-600 pl-1">
                        <Bell />
                    </Button>
                    <Button variant="ghost" size="icon" className="hidden md:block text-gray-600 pl-1">
                        <MessageCircle />
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" className="relative h-8 w-8 rounded-full">
                                <Avatar>
                                    <AvatarImage />
                                    <AvatarFallback className="dark:bg-gray-100" >D</AvatarFallback>
                                </Avatar>
                            </Button>
                        </DropdownMenuTrigger>
                            ...
                            <DropdownMenuLabel className="font-normal">
                                <div className='flex flex-col space-y-1'>
                                    <div className='flex items-center'>
                                        ...
                                        <div className=''>
                                            <p className='text-sm font-medium leading-none'>Dheeraj Agrahari</p>
                                            <p className='text-xs mt-2 text-gray-600 font-medium leading-none'>Dheeraj Agrahari</p>
                                        </div>
                                    </div>
                                </div>
                            </DropdownMenuLabel>
